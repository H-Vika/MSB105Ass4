...
#### Oppgave 42
Finn gjennomsnitt («mean») og median av de 256 (218) koeffisientene beregnet for diff_gdp_per_capita.
```{r}
NUTS2_diff |>
  summarise(
    mean_coef   = mean(diff_gdp_per_capita),
    median_coef = median(diff_gdp_per_capita)
  ) 
```
